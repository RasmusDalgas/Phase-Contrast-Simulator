...
index{1} = [0,0]; % non absorbing and refracting
index{2} = [1.6407775512258e-8,8.4269742031797E-12]; % polycarbonate 40 keV
index{3} = [4.5493879454434E-8,1.8960914557255E-11]; % carbon 40 keV
...
save(sprintf('results/compare_TSD_ACD07_%d',1),...
        'x_ACD','Pn2_ACD','Dn2_ACD','Pn1_ACD','Dn1_ACD','K_ACD', ...
        'x_TSD','Pn2_TSD','Dn2_TSD','Pn1_TSD','Dn1_TSD','K_TSD', ...
