...
index{3} = [1.0645482679374E-6,9.963989832553E-9];   % copper 40 keV
index{2} = [9.5393776498239E-7,6.4178749660696E-9];  % iron 40 keV
...
save(sprintf('results/compare_TSD_ACD04_%d',1),...
        'x_ACD','Pn2_ACD','Dn2_ACD','Pn1_ACD','Dn1_ACD','K_ACD', ...
        'x_TSD','Pn2_TSD','Dn2_TSD','Pn1_TSD','Dn1_TSD','K_TSD', ...
